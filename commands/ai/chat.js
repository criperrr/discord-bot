            ...
            if (!chatSession) {
                ...
                chatSession = ai.chats.create({
                    ...
                    history: [
                        ...
                        {
                            role: "model",
                            parts: [{ text: "Olá usuário! Sou o Gemilão, um assistente virtual em formato de bot do discord baseado no modelo Gemini 2.5 Flash. Sou capaz de gerar e interpretar somente textos por enquanto. Precisa de ajuda com algo? Quer conversar sobre algo? Pode falar comigo!" }],
                        },
                    ],
